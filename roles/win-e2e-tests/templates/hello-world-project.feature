Feature: Create a Hello World Octopus Deploy Project
  Scenario: Configure Aliases
    Given I save the current date with the format "yyyyMMddHHmmSS" to the alias "Now"
    And I modify the alias "New Project Name" by setting it to it with "HelloWorldProject"
